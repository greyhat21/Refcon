    ...
    app.post('/newmessage', (req, res) => {
        if(req.session.user){
            ...
            RefconTeacher.find({}, (err, data) => {
                ...
                res.render('newmessage', {typerror:"", success: "Message sent successfully!", availableTeachers: availableTeachers, availableFacultyIDs: availableFacultyIDs});
            });
        }
        else{
            res.render('login', {typerror: "You haven't logged in or your're session might have ended", success: ""});
